...
impl Scene {
    ...
    pub fn book_one_final() -> Self {
            ...
            for b in -11 .. 11 {
                ...
                if (center - Vec3::new(4.0, 0.2, 0.0)).length() > 0.9 {
                    ...
                    if choose_mat < 0.8 {
                        ...
                        spheres.push(Sphere::new(center, 0.2, (materials.len() - 1) as u32, 0));
                        ...
                        materials.push(sphere_material);
                        spheres.push(Sphere::new(center, 0.2, (materials.len() - 1) as u32, 1));
                    } else {
                        // glass
                        let sphere_material = Material::Dielectric(1.5);
                        materials.push(sphere_material);
                        spheres.push(Sphere::new(center, 0.2, (materials.len() - 1) as u32, 2));
                    }
                }
            }
        }
        ...
        spheres.push(Sphere::new(Vec3::new(0.0, 1.0, 0.0), 1.0, (materials.len() - 1) as u32, 2));

        let lamb_mat = Material::Lambertian(Vec3::new(0.4, 0.2, 0.1));
        materials.push(lamb_mat);
        spheres.push(Sphere::new(Vec3::new(-4.0, 1.0, 0.0), 1.0, (materials.len() - 1) as u32, 0));

        let met_mat = Material::Metal(Vec3::new(0.7, 0.6, 0.5), 0.0);
        materials.push(met_mat);
        spheres.push(Sphere::new(Vec3::new(4.0, 1.0, 0.0), 1.0, (materials.len() - 1) as u32, 1));
